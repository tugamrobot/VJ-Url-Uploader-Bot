...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "6570626731:AAEC3OF3zeM5Oj_ovXefxThKTK2m2A84qFY")
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "mia_69_khalifa_bot") # Bot username without @.
    
    # The Telegram API things
    TECH_VJ_API_ID = int(os.environ.get("TECH_VJ_API_ID", "10738493"))
    TECH_VJ_API_HASH = os.environ.get("TECH_VJ_API_HASH", "470da6bd517277ac20c0b6b3a1d3807")
    ...
    TECH_VJ_OWNER_ID = int(os.environ.get("TECH_VJ_OWNER_ID", "6500565840")) 
    TECH_VJ_SESSION_NAME = "VJ-URL-UPLOADER-BOT"
    
    # database uri (mongodb)
    TECH_VJ_DATABASE_URL = os.environ.get("TECH_VJ_DATABASE_URL", "mongodb+srv://newincome:newincome-opo@cluster1.kgjm7o8.mongodb.net/?retryWrites=true&w=majority&appName=Cluster1")
    TECH_VJ_MAX_RESULTS = "50"

    # channel information
    TECH_VJ_LOG_CHANNEL = int(os.environ.get("TECH_VJ_LOG_CHANNEL", "-1002086816618")) # your log channel id and make bot admin in log channel with full right 
