...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "6580034468:AAEHkxrFBfSWizP3-dke0Spu7MwU1Qk4c2Q")
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "url_uploads_1_bot") # Bot username without @.
